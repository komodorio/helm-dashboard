        ...
        '/api/helm/releases/{ns}/{name}/manifest': {
            ...
            get: {
                ...
                responses: {
                    '200': {
                        description:
                            'Manifest text, or diff if revisionDiff is specified',
                    },
                },
            },
        },
        '/api/helm/releases/{ns}/{name}/values': {
            parameters: [
                ...
                },
                {
                    ...
                    in: 'query',
                    description:
                        'If set, only user-defined values will be listed',
                },
            ],
            get: {
                tags: ['Releases'],
        ...
        '/api/helm/releases/{ns}/{name}/notes': {
            ...
            get: {
                ...
                responses: {
                    '200': {
                        description:
                            'Notes text, or diff if revisionDiff is specified',
                    },
                },
            },
        },
        ...
        '/api/helm/repositories': {
            ...
            post: {
                ...
                responses: {
                    '204': {
                        description:
                            'Empty response in case repository were added',
                    },
                },
            },
        },
        ...
        '/api/helm/repositories/latestver': {
            ...
            get: {
                ...
                responses: {
                    '200': {
                        description:
                            'The object with latest available version is returned',
                    },
                    '204': {
                        description:
        ...
        '/api/scanners/resource/{kind}': {
            ...
            get: {
                ...
                responses: {
                    '200': {
                        description:
                            'Information with scan results per scanner type',
                    },
                },
            },
        },
                ...
                responses: {
                    '200': {
                        ...
                        headers: {
                            'X-Application-Name': {
                                description:
                                    'A string to self-identify the application',
                            },
                        },
                    },
                },
