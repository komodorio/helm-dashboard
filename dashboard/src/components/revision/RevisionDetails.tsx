...
export default function RevisionDetails({
                ...
                <div className="flex flex-row flex-wrap gap-3 float-right h-fit">
                    <div className="flex flex-col">
                        ...
                        {latestVerData?.[0]?.isSuggestedRepo ? (
                            ...
                            >
                                Add repository for it:{' '}
                                {latestVerData[0].repository}
                            </span>
                        ) : (
                            <span
    ...
    return (
        <div className="flex flex-col px-16 pt-5 gap-3">
            ...
            <span
                className={`text-sm ${
                    release.status === DeploymentStatus.FAILED
                        ? 'text-red-600'
                        : ''
                }`}
            >
...
const Uninstall = () => {
    ...
    const uninstallTitle = (
        <div className="font-semibold text-lg">
            Uninstall <span className="text-red-500">{chart}</span> from
