  ...
  return (
    <Modal
      ...
      bottomContent={
        <div className="flex justify-end p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
          <button
            className="text-white bg-[#1347FF] hover:bg-[#0b5ed7] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
    ...
    >
      ...
      <div className="w-[400px] flex flex-row gap-1">
        <input
          type="text"
          className="rounded-lg p-2 w-1/2 border border-gray-300"
        />
        <input
          type="text"
          className="rounded-lg p-2 w-1/2 border border-gray-300"
