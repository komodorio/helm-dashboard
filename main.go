...
type options struct {
	Version    string `long:"version" description:"Show tool version"  default:"0.0.0"`
	...
	Commit     string `long:"commit" description:"Build commit" default:"none"`
	Date       string `long:"date" description:"build date" default:"unknown"`
}
...
func main() {
	...
	setupLogging(opts.Verbose, opts.Version, opts.Commit, opts.Date)
...
func setupLogging(verbose bool, version string, commit string, date string) {
	if verbose {
